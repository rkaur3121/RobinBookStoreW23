...
using RobinBooks.Models.ViewModels;
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ProductVM productVM = new ProductVM()
            {
                ...
                CoverTypeList = (IEnumerable<System.Web.Mvc.SelectListItem>)_unitOfWork.Cover.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                })
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            ...
            else
            {
                ...
                productVM.CoverTypeList = (IEnumerable<System.Web.Mvc.SelectListItem>)_unitOfWork.Cover.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                });
